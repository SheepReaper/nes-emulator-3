...
public static class LabCapabilityCatalog
{
    ...
    [
        ...
        Capability("baseline", "Inspect or safely adopt verified conformance improvements.",
            "Updates require a current complete indexed run and can never accept a new or diagnostically changed failure.",
            Operation("show", "Read the current accepted conformance baseline."),
            Operation("update", "Preview or explicitly apply an improvement-only baseline update.", "runId", "apply")),
